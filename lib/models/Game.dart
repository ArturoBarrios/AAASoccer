...
class Game extends Model {
  ...
  const Game._internal({required this.id, hometeam, awayTeam, score, wagers, pickup, createdAt, updatedAt}): _hometeam = hometeam, _awayTeam = awayTeam, _score = score, _wagers = wagers, _pickup = pickup, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Game({String? id, String? hometeam, String? awayTeam, String? score, String? wagers, bool? pickup}) {
  ...
  Game copyWith({String? id, String? hometeam, String? awayTeam, String? score, String? wagers, bool? pickup}) {
    return Game._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'hometeam': _hometeam, 'awayTeam': _awayTeam, 'score': _score, 'wagers': _wagers, 'pickup': _pickup, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
