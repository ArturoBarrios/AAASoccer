...
class AppSubscription extends Model {
  ...
  const AppSubscription._internal({required this.id, tier, createdAt, updatedAt}): _tier = tier, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory AppSubscription({String? id, String? tier}) {
  ...
  AppSubscription copyWith({String? id, String? tier}) {
    return AppSubscription._internal(
      id: id ?? this.id,
      tier: tier ?? this.tier);
  }
