...
class User extends Model {
  ...
  const User._internal(
      ...
      : _player = player,
        ...
        _userOrganizerId = userOrganizerId,
        _userCoachId = userCoachId,
        _userRefereeId = userRefereeId;
  ...
  factory User(
    ...
    return User._internal(
        ...
        locations: locations != null
            ? List<Location>.unmodifiable(locations)
            : locations,
  ...
  String toString() {
    ...
    buffer.write("last_login=" +
        (_last_login != null ? _last_login!.toString() : "null") +
        ", ");
    buffer.write("last_updated=" +
        (_last_updated != null ? _last_updated!.toString() : "null") +
        ", ");
  ...
  User.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        _player = json['player']?['serializedData'] != null
            ? Player.fromJson(
                new Map<String, dynamic>.from(json['player']['serializedData']))
            : null,
        _organizer = json['organizer']?['serializedData'] != null
            ? Organizer.fromJson(new Map<String, dynamic>.from(
                json['organizer']['serializedData']))
            : null,
        _coach = json['coach']?['serializedData'] != null
            ? Coach.fromJson(
                new Map<String, dynamic>.from(json['coach']['serializedData']))
            : null,
        _referee = json['referee']?['serializedData'] != null
            ? Referee.fromJson(new Map<String, dynamic>.from(
                json['referee']['serializedData']))
            : null,
        _name = json['name'],
        _phone = json['phone'],
        _email = json['email'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'organizer': _organizer?.toJson(),
        'coach': _coach?.toJson(),
        'referee': _referee?.toJson(),
        'name': _name,
        'phone': _phone,
        'email': _email,
        'username': _username,
        ...
        'locations': _locations?.map((Location? e) => e?.toJson()).toList(),
        'createdAt': _createdAt?.format(),
        'updatedAt': _updatedAt?.format(),
        'userPlayerId': _userPlayerId,
        'userOrganizerId': _userOrganizerId,
        'userCoachId': _userCoachId,
        'userRefereeId': _userRefereeId
      };
  ...
  static final QueryField USERORGANIZERID =
      QueryField(fieldName: "userOrganizerId");
  static final QueryField USERCOACHID = QueryField(fieldName: "userCoachId");
  static final QueryField USERREFEREEID =
      QueryField(fieldName: "userRefereeId");
  static var schema =
