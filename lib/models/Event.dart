...
import 'ModelProvider.dart' as model_provider;
...
class Event extends Model {
  ...
  final model_provider.EventType? _type;
  final String? _locationID;
  final String? _trainingID;
  final String? _tournamentID;
  final String? _leagueID;
  final String? _tryoutID;
  final List<model_provider.TryoutEvent>? _tryouts;
  final List<model_provider.LeagueEvent>? _leagues;
  final List<model_provider.TournamentEvent>? _tournaments;
  final List<model_provider.TrainingEvent>? _trainings;
  ...
  model_provider.EventType? get type {
    return _type;
  }
  ...
  List<model_provider.TryoutEvent>? get tryouts {
    return _tryouts;
  }

  List<model_provider.LeagueEvent>? get leagues {
    return _leagues;
  }

  List<model_provider.TournamentEvent>? get tournaments {
    return _tournaments;
  }

  List<model_provider.TrainingEvent>? get trainings {
    return _trainings;
  }
  ...
  factory Event(
      ...
      String? price,
      String? location,
      model_provider.EventType? type,
      String? locationID,
      String? trainingID,
      String? tournamentID,
      String? leagueID,
      String? tryoutID,
      List<model_provider.TryoutEvent>? tryouts,
      List<model_provider.LeagueEvent>? leagues,
      List<model_provider.TournamentEvent>? tournaments,
      List<model_provider.TrainingEvent>? trainings}) {
    return Event._internal(
        ...
        leagueID: leagueID,
        tryoutID: tryoutID,
        tryouts: tryouts != null
            ? List<model_provider.TryoutEvent>.unmodifiable(tryouts)
            : tryouts,
        leagues: leagues != null
            ? List<model_provider.LeagueEvent>.unmodifiable(leagues)
            : leagues,
        tournaments: tournaments != null
            ? List<model_provider.TournamentEvent>.unmodifiable(tournaments)
            : tournaments,
        trainings: trainings != null
            ? List<model_provider.TrainingEvent>.unmodifiable(trainings)
            : trainings);
  }
  ...
  Event.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _type = enumFromString<model_provider.EventType>(
            json['type'], model_provider.EventType.values),
        ...
        _tryouts = json['tryouts'] is List
            ? (json['tryouts'] as List)
                ...
                .map((e) => model_provider.TryoutEvent.fromJson(
        ...
        _leagues = json['leagues'] is List
            ? (json['leagues'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => model_provider.LeagueEvent.fromJson(
                    new Map<String, dynamic>.from(e['serializedData'])))
                .toList()
            : null,
        _tournaments = json['tournaments'] is List
            ? (json['tournaments'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => model_provider.TournamentEvent.fromJson(
                    new Map<String, dynamic>.from(e['serializedData'])))
                .toList()
            : null,
        _trainings = json['trainings'] is List
            ? (json['trainings'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => model_provider.TrainingEvent.fromJson(
                    new Map<String, dynamic>.from(e['serializedData'])))
                .toList()
            : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'tryoutID': _tryoutID,
        'tryouts': _tryouts
            ?.map((model_provider.TryoutEvent? e) => e?.toJson())
            .toList(),
        'leagues': _leagues
            ?.map((model_provider.LeagueEvent? e) => e?.toJson())
            .toList(),
        'tournaments': _tournaments
            ?.map((model_provider.TournamentEvent? e) => e?.toJson())
            .toList(),
        'trainings': _trainings
            ?.map((model_provider.TrainingEvent? e) => e?.toJson())
            .toList(),
  ...
  static final QueryField TRYOUTS = QueryField(
      ...
      fieldType: ModelFieldType(ModelFieldTypeEnum.model,
          ofModelName: (model_provider.TryoutEvent).toString()));
  static final QueryField LEAGUES = QueryField(
      fieldName: "leagues",
      fieldType: ModelFieldType(ModelFieldTypeEnum.model,
          ofModelName: (model_provider.LeagueEvent).toString()));
  static final QueryField TOURNAMENTS = QueryField(
      fieldName: "tournaments",
      fieldType: ModelFieldType(ModelFieldTypeEnum.model,
          ofModelName: (model_provider.TournamentEvent).toString()));
  static final QueryField TRAININGS = QueryField(
      fieldName: "trainings",
      fieldType: ModelFieldType(ModelFieldTypeEnum.model,
          ofModelName: (model_provider.TrainingEvent).toString()));
  static var schema =
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
        ...
        isRequired: false,
        ofModelName: (model_provider.TryoutEvent).toString(),
        associatedKey: model_provider.TryoutEvent.EVENT));

    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
        key: Event.LEAGUES,
        isRequired: false,
        ofModelName: (model_provider.LeagueEvent).toString(),
        associatedKey: model_provider.LeagueEvent.EVENT));

    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
        key: Event.TOURNAMENTS,
        isRequired: false,
        ofModelName: (model_provider.TournamentEvent).toString(),
        associatedKey: model_provider.TournamentEvent.EVENT));

    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
        key: Event.TRAININGS,
        isRequired: false,
        ofModelName: (model_provider.TrainingEvent).toString(),
        associatedKey: model_provider.TrainingEvent.EVENT));
