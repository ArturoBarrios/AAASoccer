...
class Chat extends Model {
  ...
  const Chat._internal({required this.id, messages, createdAt, updatedAt}): _messages = messages, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Chat({String? id, String? messages}) {
  ...
  Chat copyWith({String? id, String? messages}) {
    return Chat._internal(
      id: id ?? this.id,
